...
# ------------------ 页面配置 ------------------
st.set_page_config(page_title="跳深动作-前交叉韧带应力预测", layout="wide")
...
# ------------------ 页面标题 ------------------
st.markdown(
    "<h1 style='text-align: center; color: darkred; margin-bottom: 40px;'>跳深动作-前交叉韧带应力预测</h1>",
    unsafe_allow_html=True
)

# ------------------ 加载模型 ------------------
MODEL_PATH = "TS_XGJ_model.bin"
